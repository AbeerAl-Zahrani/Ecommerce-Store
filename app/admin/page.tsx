...
async function getUserData() {
    ...
    return {
        userCount,
        averageValueOfUser: userCount === 0 ? 0 : (orderData._sum.pricePaidInCents || 0) / userCount / 100
    }
}
...
export default async function AdminDashboard() {
    ...
    return <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <DashboardCard title="Customers" subTitle={`${formatCurrency(userData.averageValueOfUser)} Average Value`} body={`${formatCurrency(userData.userCount)} `} />
